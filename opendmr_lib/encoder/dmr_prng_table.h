/* DMR AMBE+2 PRNG table for B-block scrambling
 * From MMDVM Host (AMBEFEC.cpp) by Jonathan Naylor G4KLX
 * Copyright (C) 2010,2014,2016,2018,2021,2023,2025 by Jonathan Naylor G4KLX
 * Licensed under GPLv2+
 */

#ifndef DMR_PRNG_TABLE_H
#define DMR_PRNG_TABLE_H

static const unsigned int DMR_PRNG_TABLE[4096] = {
