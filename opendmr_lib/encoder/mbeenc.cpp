...
#include "dmr_prng_table.h"       // Correct 4096-entry PRNG table for B-block scrambling
...
/* PRNG table for B-block scrambling is in dmr_prng_table.h (DMR_PRNG_TABLE, 4096 entries) */
...
void MBEEncoder::encode_dmr(const unsigned char* in, unsigned char* out)
{
	...
	unsigned int p = DMR_PRNG_TABLE[aOrig] >> 1;
